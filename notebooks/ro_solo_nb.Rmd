...
districts %>%
  ...
  labs(x = "Algebra I Proficiency Rate", y = "Algebra II Proficiency Rate") +
...
districts %>%
  ...
  scale_y_continuous(labels = scales::comma, limits = c(0, 306000), expand = c(0, 0)) +
  theme_minimal() +
...
districts %>%
  ...
  scale_y_continuous(breaks = seq(0, 120000, by = 20000), labels = scales::comma, limits = c(0, 122400), expand = c(0, 0)) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust=1))
```
...
districts %>%
  ...
  scale_y_continuous(breaks = seq(0, 100, by = 20), limits = c(0, 102), expand = c(0, 0)) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust=1))
```
...
districts %>%
  ...
  geom_histogram(color = "#333333", fill = "lightsteelblue4") +
  geom_hline(yintercept = 0, size = 1.5, color = "#333333") +
  labs(x = "Difference in Algebra I and Algebra II Proficiency Rates", y = "Districts") +
  scale_x_continuous(limits = c(-25, 65), expand = c(0, 0)) +
  scale_y_continuous(breaks = seq(0, 12, by = 4), limits = c(0, 12.24), expand = c(0, 0)) +
  theme_minimal()
```
...
districts %>% 
  ...
  geom_col(color = "#333333", fill = "lightsteelblue4") +
  geom_hline(yintercept = 0, size = 0.75, color = "#333333") +
  labs(title = "Correlations with Graduation Rate", x = "", y = "Pearson Correlation") +
  scale_y_continuous(
...
districts %>%
  ...
  geom_point(color = "#333333", fill = "lightsteelblue4", pch = 21, size = 2) +
  geom_hline(yintercept = -0.5, size = 1.5, color = "#333333") +
  geom_vline(xintercept = -1.5, size = 1.5, color = "#333333") +
  labs(title = "Graduation vs. Suspension Rates by School", x = "Graduation Rate", y = "Suspension Rate") +
  scale_x_continuous(breaks = seq(0, 100, by = 20), limits = c(-1.5, 102), expand = c(0, 0)) +
  scale_y_continuous(breaks = seq(0, 25, by = 5), limits = c(-0.5, 25.5), expand = c(0, 0)) +
  theme_minimal()
```
...
testing %>%
  ...
  geom_col(color = "#333333", fill = "lightsteelblue4") +
  geom_hline(yintercept = 0, size = 1.5, color = "#333333") +
  labs(title = "Algebra I Advanced Percentage by Grade Level", x = "Grade", y = "Percentage") +
  scale_y_continuous(breaks = seq(0, 40, by = 5), limits = c(0, 40.8), expand = c(0, 0)) +
  theme_minimal()
```
...
alg_pct_adv %>%
  ...
  geom_vline(xintercept = -1.5, size = 1.5, color = "#333333") +
  labs(
    title = "Algebra I vs. II Advanced Percentages by School", 
